...
if __name__ == "__main__":
    ...
    scheduler.add_job(
        run_voa,
        trigger=CronTrigger(day_of_week="mon-fri", hour=7, minute=45, timezone=sydney_tz),
        id="voa_monitor",
        name="VoA Monitor (daily 7:45am)",
    )
    log.info("VoA Monitor scheduled — daily 7:45am Mon-Fri.")
